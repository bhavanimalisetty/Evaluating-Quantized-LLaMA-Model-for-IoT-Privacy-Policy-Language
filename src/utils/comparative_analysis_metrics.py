...
class Metrics:
    def getAllMetrics(self, df_q4: pd.DataFrame, df_q5: pd.DataFrame, df_q8: pd.DataFrame) -> None:
        ...
        rougeMetric.getRougeMetric(df_q4, df_q5, df_q8)
        bertMetric = BertMetric()
        bertMetric.getBertMetric(df_q4, df_q5, df_q8)
        ...
        for wordEmbeddingModelName in WordEmbeddingModels:
            ...
            wordEmbeddingModel.getWordEmbeddings(df_q4, df_q5, df_q8)
